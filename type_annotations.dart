...
void main() {
  ...
  int age = 25;
  print(age); // 25
  age = 34; // value of a type declared variable can be changed, but the type cannot be changed once declared
  print(age); // 34
  ...
  print(avgRating); // 8.9
  avgRating = 9; // value can be `int` in a `double` type variable, but the opposite is not true
  print(avgRating); // 9
  ...
  // Mostly, we use `var` to declare variables, as Dart detects the correct datatype, unless we want to be very specific. Like `double`, etc.
